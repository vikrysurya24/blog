...
@section('breadcrumbs')
    {{ Breadcrumbs::render('detail-role', $role) }}
@endsection
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                                    ...
                                    @foreach ($permissions as $permission)
                                        ...
                                        <li class="list-group-item">
                                            <div class="form-check">
                                                ...
                                                value="" onclick="return false;" {{ in_array($permission, $rolePermissions) ? 'checked' : '' }}>
                            ...
                            @empty
                                <strong class="text-danger text-center">{{ trans('roles.label.no_data.fetch') }}</strong>
                            @endforelse
                        </div>
                    </div>
                    <!-- button  -->
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('roles.index') }}" class="btn btn-secondary mx-1" role="button">
